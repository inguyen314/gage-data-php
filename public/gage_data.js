        ...
        fetch(urlStage29)
            ...
            .then(stage29 => {
                ...
                stage29CwmsIdCellInnerHTML = "<span class='" + floodClass + "' title='" + stage29.cwms_ts_id + "'>"
                    + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + stage29_cwms_ts_id + "&lookback=96' target='_blank'>"
                    + stage29_value
                    + "</a>"
                    + "</span>"
                    + " "
        ...
        fetch(urlStage)
            ...
            .then(stage => {
                ...
                stageCellInnerHTML = "<span class='" + floodClass + "' title='" + stage_cwms_ts_id + "   " + "Flood=" + flood_level + "'>"
                    + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + stage_cwms_ts_id + "&lookback=96' target='_blank'>"
                    + stage_value
                    + "</a>"
                    + "</span>"
                    + " "
            ...
            .then(nwsData => {
                ...
                if (nwsData !== null) {
                    ...
                    stageCellInnerHTML = "<table id='nws'>"
                        ...
                        + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + tsid_stage_nws_3_day_forecast + "&lookback=96' title='" + tsid_stage_nws_3_day_forecast + " " + nwsData.date_time_day1 + "' target='_blank'>"
                        + nws1_value
                        + "</a>"
                        + "</td>"
                        + "<td class='" + floodClassNWSDay2 + "'>"
                        + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + tsid_stage_nws_3_day_forecast + "&lookback=96' title='" + tsid_stage_nws_3_day_forecast + " " + nwsData.date_time_day2 + "' target='_blank'>"
                        + nws2_value
                        + "</a>"
                        + "</td>"
                        + "<td class='" + floodClassNWSDay3 + "'>"
                        + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + tsid_stage_nws_3_day_forecast + "&lookback=96' title='" + tsid_stage_nws_3_day_forecast + " " + nwsData.date_time_day3 + "' target='_blank'>"
                        + nws3_value
                        + "</a>"
                        + "</td>"
                        + "</tr>"
                ...
                .then(stage => {
                    if (stage) {
                        ...
                        stageCellInnerHTML = "<span class='" + floodClass + "' title='" + stage.cwms_ts_id + "'>"
                            + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + stage.cwms_ts_id + "&lookback=96' target='_blank'>"
                            + stage_value
                            + "</a>"
                            + "</span>"
                            + " "
            ...
            .then(flow => {
                ...
                if (flow !== null) {
                    ...
                    flowCellInnerHTML = "<span class='last_max_value' title='" + flow.cwms_ts_id + "'>"
                        + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + flow.cwms_ts_id + "&lookback=96' target='_blank'>"
                        + rounded_flow_value
                        + "</a>"
                        + "</span>"
                        + " "
            ...
            .then(precip => {
                ...
                if (precip !== null) {
                    ...
                    precipCwmsIdCellInnerHTML = "<table id='precip'>"
                        ...
                        + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + precip_cwms_ts_id + "&lookback=96' title='" + precip_cwms_ts_id + "' target='_blank'>"
                        + precip_value
                        + "</a>"
                        + "</span>"
                        + " "
            ...
            .then(waterQuality => {
                ...
                if (waterQuality !== null) {
                    ...
                    waterQualityCellInnerHTML = "<span class='last_max_value' title='" + waterQuality.cwms_ts_id + " " + water_quality_value + "'>"
                        + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + waterQuality.cwms_ts_id + "&lookback=96' target='_blank'>"
                    ...
                    waterQualityCellInnerHTML = "<span class='missing' title='" + tsid + "'>"
                        + "<a href='../../chart/index.html?office=MVS&cwms_ts_id=" + tsid + "&lookback=96' target='_blank'>"
                        + "-M-"
                        + "</a>"
                        + "</span>"
                        + "<span class='" + myWaterQualityClass + "'>"
