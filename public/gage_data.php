...
<head>
    ...
    <title>Realtime Gage Data</title>
        ...
        <div class="page-wrap">
            <div class="container-fluid">
                    ...
                    <div id="topPane" class="col-md backend-cp-collapsible">
                        <div class="box-usace">
                            <h2 class="box-header-striped">
                                <span class="titleLabel title">Realtime Gage Data</span>
                                <span class="rss"></span>
                            </h2>
                            <div class="box-content" style="background-color:white;margin:auto">
                                <div class="content">
                                    <!-- Box Content Here -->
                                    <!-- <span>
                                        <h3><a href='gage_data.php?basin=Mississippi'>Switch to PHP</a></h3>
                                    </span> -->
                                    <!-- <span>
                                        <h3><a href='gage_data.html?basin=Mississippi&cda=internal'>Switch to Cloud</a></h3>
                                    </span> -->
                ...
                <script>
                    ...
                    // Dynamically title block
                    title = "Realtime Gage Data - " + " " + basin;
                    if (title) {
