    ...
    if (display_stage_29 === true) {
        ...
        .then(stage29 => {
            ...
            stage29CwmsIdCellInnerHTML  = "<span class='" + floodClass + "' title='" + stage29.cwms_ts_id + "'>"
                                        + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + stage29_cwms_ts_id + "&start_day=4&end_day=0' target='_blank'>"
                                        + stage29_value
                                        + "</a>"
                                        +"</span>" 
                                        + " " 
    ...
    // NON-PROJECT GAGE STAGES WITH 3 DAYS NWS FORECAST
        ...
        // GET STAGE VALUE
            ...
            stageCellInnerHTML  = "<span class='" + floodClass + "' title='" + stage_cwms_ts_id + "   " + "Flood=" + flood_level + "'>"
                                + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + stage_cwms_ts_id + "&start_day=4&end_day=0' target='_blank'>"
                                + stage_value
                                + "</a>"
                                +"</span>" 
                                + " " 
        ...
        .then(nwsData => {
            ...
            if (nwsData !== null) {
                ...
                stageCellInnerHTML  = "<table id='nws'>"
                                    ...
                                    + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + tsid_stage_nws_3_day_forecast + "&start_day=0&end_day=4' title='" + tsid_stage_nws_3_day_forecast + " " + nwsData.date_time_day1 + "' target='_blank'>"
                                    + nws1_value
                                    + "</a>"
                                    + "</td>"
                                    + "<td class='" + floodClassNWSDay2 + "'>" 
                                    + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + tsid_stage_nws_3_day_forecast + "&start_day=0&end_day=4' title='" + tsid_stage_nws_3_day_forecast + " " + nwsData.date_time_day2 + "' target='_blank'>"
                                    + nws2_value
                                    + "</a>"
                                    + "</td>"
                                    + "<td class='" + floodClassNWSDay3 + "'>" 
                                    + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + tsid_stage_nws_3_day_forecast + "&start_day=0&end_day=4' title='" + tsid_stage_nws_3_day_forecast + " " + nwsData.date_time_day3 + "' target='_blank'>"
                                    + nws3_value
                                    + "</a>"
                                    + "</td>"
                                    + "</tr>"
        ...
        .then(flow => {
            ...
            if (flow !== null) {
                ...
                flowCellInnerHTML   = "<span class='last_max_value' title='" + flow.cwms_ts_id + "'>"
                                    + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + flow.cwms_ts_id + "&start_day=4&end_day=0' target='_blank'>"
                                    + rounded_flow_value
                                    + "</a>"
                                    + "</span>"
                                    + " "
        ...
        .then(precip => {
            ...
            if (precip !== null) {
                ...
                precipCwmsIdCellInnerHTML   = "<table id='precip'>"
                                            ...
                                            + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + precip_cwms_ts_id + "&start_day=4&end_day=0' title='" + precip_cwms_ts_id + "' target='_blank'>"
                                            + precip_value
                                            + "</a>"
                                            + "</span>"
                                            + " "
        ...
        .then(waterQuality => {
            ...
            if (waterQuality !== null) {
                ...
                waterQualityCellInnerHTML   = "<span class='last_max_value' title='" + waterQuality.cwms_ts_id + " " + water_quality_value + "'>"
                                            + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + waterQuality.cwms_ts_id + "&start_day=4&end_day=0' target='_blank'>"
                ...
                waterQualityCellInnerHTML = "<span class='missing' title='" + tsid + "'>"
                                            + "<a href='https://wm.mvs.ds.usace.army.mil/web_apps/plot_macro/public/plot_macro.php?cwms_ts_id=" + tsid + "&start_day=4&end_day=0' target='_blank'>"
                                            + "-M-"
                                            + "</a>"
                                            + "</span>"
                                            + "<span class='" + myWaterQualityClass + "'>"
