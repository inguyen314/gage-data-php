        ...
        .then(stage => {
            ...
            if (valueLast === null) {
                ...
                innerHTMLStage = "<span class='" + floodClass + "' title='" + stage.name + ", Value = " + valueLast + ", Date Time = " + timestampLast + "'>"
                                + "<a href='https://wm.mvs.ds.usace.army.mil/District-Templates/chart/public/chart.html?cwms_ts_id=" + stage.name + "&lookback=96' target='_blank'>"
                                + valueLast
                                + "</a>"
                                +"</span>" 
                                + " " 
            ...
            .then(nws3Days => {
                ...
                if (nws3Days !== null) {
                    innerHTMLStage  = "<table id='nws'>"
                                    ...
                                    + "<a href='../../../District-Templates/chart/public/chart.html?cwms_ts_id=" + nws3Days.name + "&lookback=96' target='_blank' title='" + nws3Days.name + " " + firstFirstValue + "'>"
                                    + firstMiddleValue
                                    + "</a>"
                                    + "</td>"
                                    + "<td class='" + floodClassDay2 + "'>" 
                                    + "<a href='../../../District-Templates/chart/public/chart.html?cwms_ts_id=" + nws3Days.name + "&lookback=96' target='_blank' title='" + nws3Days.name + " " + secondFirstValue + "'>"
                                    + secondMiddleValue
                                    + "</a>"
                                    + "</td>"
                                    + "<td class='" + floodClassDay3 + "'>" 
                                    + "<a href='../../../District-Templates/chart/public/chart.html?cwms_ts_id=" + nws3Days.name + "&lookback=96' target='_blank' title='" + nws3Days.name + " " + thirdFirstValue + "'>"
                                    +  thirdMiddleValue
                                    + "</a>"
                                    + "</td>"
                                    + "</tr>"
            ...
            .then(flow => {
                ...
                if (lastNonNullFlowValue === null) {
                    ...
                    innerHTMLFlow = "<span class='last_max_value' title='" + flow.name + ", Value = " + roundedValueFlowLast + ", Date Time = " + timestampFlowLast + "'>"
                                    + "<a href='https://wm.mvs.ds.usace.army.mil/District-Templates/chart/public/chart.html?cwms_ts_id=" + flow.name + "&lookback=96' target='_blank'>"
            ...
            .then(precip => {
                ...
                if (lastNonNullPrecipValue === null) {
                    ...
                    innerHTMLPrecip =   "<table id='precip'>"
                                        ...
                                        + "<a href='../../../District-Templates/chart/public/chart.html?cwms_ts_id=" + precip.name + "&lookback=96' target='_blank'>"
                                            + valuePrecipLast
                                            + "</a>"
                                        + "</span>"
                                        + " "
            ...
            .then(waterQuality => {
                ...
                if (lastNonNullWaterQualityValue === null) {
                    ...
                    innerHTMLWaterQuality = "<span class='last_max_value' title='" + waterQuality.name + ", Value = " + valueWaterQualityLast + ", Date Time = " + timestampWaterQualityLast + "'>"
                                    + "<a href='https://wm.mvs.ds.usace.army.mil/District-Templates/chart/public/chart.html?cwms_ts_id=" + waterQuality.name + "&lookback=96' target='_blank'>"
